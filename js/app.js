let add=document.querySelector('.fa-angle-down');
let AddTask=document.querySelector('.AddTask');
let icon=document.querySelector('.ico .fa-angle-down')
console.log(icon);
console.log(AddTask);
...
AddButton.onclick=function(){
    if (input[0].value.length==0) {
        h4.textContent='Please Enter Missing Information';
...
let Mood=document.querySelector('.ico .fa-moon');
